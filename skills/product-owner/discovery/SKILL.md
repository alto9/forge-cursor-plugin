...
name: discovery
description: >-
  product-owner procedure: discovery. Propose-only when spawned from event commands; touch product/ docs via templates.
---
...
Invoked by Forge event commands or the product-owner agent for `product-owner/discovery`.
