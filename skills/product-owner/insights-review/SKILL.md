...
Invoked by `/forge.insights-review` (formerly `/forge.discovery`) or the product-owner agent for monthly insights/personas/brief synthesis. **Not** initiative intake — large ideas use `/forge.new-initiative`.
