...
description: >-
  product-owner procedure: decision hygiene. Propose-only when spawned from event commands; touch product/ docs via templates.
---
...
Invoked by Forge event commands or the product-owner agent for `product-owner/decision-hygiene`.
