...
2. For `product/brief.md`: update frontmatter fields (`product`, `problem`, `audience`, etc.); body is expansion-only (context, rationale, links). Do not duplicate frontmatter lists in the body. For other product docs: required H2s only; empty sections OK; no extra H2s.
