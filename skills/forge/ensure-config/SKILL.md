...
5. Validate required fields always; validate board fields only when the event will sync the board.
6. Do not block non-board events (e.g. architecture-review) on missing `statusIds`.
