...
description: >-
  quality-assurance procedure: exploratory test. Propose-only when spawned from event commands; touch qa/ docs via templates.
---
...
Invoked by Forge event commands or the quality-assurance agent for `quality-assurance/exploratory-test`.
