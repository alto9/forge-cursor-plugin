...
description: >-
  quality-assurance procedure: regression check. Propose-only when spawned from event commands; touch qa/ docs via templates.
---
...
Invoked by Forge event commands or the quality-assurance agent for `quality-assurance/regression-check`.
