...
description: >-
  quality-assurance procedure: verify acceptance. Propose-only when spawned from event commands; touch qa/ docs via templates.
---
...
Invoked by Forge event commands or the quality-assurance agent for `quality-assurance/verify-acceptance`.
