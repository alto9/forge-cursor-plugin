...
name: threat-model
description: >-
  security procedure: threat model. Propose-only when spawned from event commands; touch security/ docs via templates.
---
...
Invoked by Forge event commands or the security agent for `security/threat-model`.
