...
name: harden-config
description: >-
  security procedure: harden config. Propose-only when spawned from event commands; touch security/ docs via templates.
---
...
Invoked by Forge event commands or the security agent for `security/harden-config`.
