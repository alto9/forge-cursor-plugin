...
4. When event-spawned from validate-ticket: return Intent + Security verdict + Proposed vendor actions (none — parent posts the comment). Do **not** propose memory edits. Do **not** Apply, HITL, or mutate SCM.
