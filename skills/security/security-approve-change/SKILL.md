...
4. When event-spawned from validate-ticket: return Intent + Security verdict + Proposed vendor actions (none — parent posts the comment / merge). Do **not** propose memory edits. Do **not** Apply, pause with the orchestrator, or mutate SCM.
