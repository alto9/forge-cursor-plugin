---
name: competitive-angle
description: >-
  marketing-manager procedure: competitive angle. Propose-only when spawned from event commands; touch marketing/ docs via templates.
---
...
Invoked by Forge event commands or the marketing-manager agent for `marketing-manager/competitive-angle`.
