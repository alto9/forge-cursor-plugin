...
description: >-
  marketing-manager procedure: content calendar. Propose-only when spawned from event commands; touch marketing/ docs via templates.
---
...
Invoked by Forge event commands or the marketing-manager agent for `marketing-manager/content-calendar`.
