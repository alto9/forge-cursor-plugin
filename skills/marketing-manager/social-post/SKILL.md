...
name: social-post
description: >-
  marketing-manager procedure: social post. Propose-only when spawned from event commands; touch marketing/ docs via templates.
---
...
Invoked by Forge event commands or the marketing-manager agent for `marketing-manager/social-post`.
