...
name: write-tests
description: >-
  engineer procedure: write tests. Propose-only when spawned from event commands; touch engineering/ docs via templates.
---
...
Invoked by Forge event commands or the engineer agent for `engineer/write-tests`.
