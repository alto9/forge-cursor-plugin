...
description: >-
  engineer procedure: respond to review. Propose-only when spawned from event commands; touch engineering/ docs via templates.
---
...
Invoked by Forge event commands or the engineer agent for `engineer/respond-to-review`.
