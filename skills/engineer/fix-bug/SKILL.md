...
name: fix-bug
description: >-
  engineer procedure: fix bug. Propose-only when spawned from event commands; touch engineering/ docs via templates.
---
...
Invoked by Forge event commands or the engineer agent for `engineer/fix-bug`.
