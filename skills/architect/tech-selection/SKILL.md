...
name: tech-selection
description: >-
  architect procedure: tech selection. Propose-only when spawned from event commands; touch architecture/ docs via templates.
---
...
Invoked by Forge event commands or the architect agent for `architect/tech-selection`.
