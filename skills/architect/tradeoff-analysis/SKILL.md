...
description: >-
  architect procedure: tradeoff analysis. Propose-only when spawned from event commands; touch architecture/ docs via templates.
---
...
Invoked by Forge event commands or the architect agent for `architect/tradeoff-analysis`.
