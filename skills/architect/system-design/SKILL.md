...
name: system-design
description: >-
  architect procedure: system design. Propose-only when spawned from event commands; touch architecture/ docs via templates.
---
...
Invoked by Forge event commands or the architect agent for `architect/system-design`.
