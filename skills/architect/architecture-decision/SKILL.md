...
description: >-
  architect procedure: architecture decision. Propose-only when spawned from event commands; touch architecture/ docs via templates.
---
...
Invoked by Forge event commands or the architect agent for `architect/architecture-decision`.
