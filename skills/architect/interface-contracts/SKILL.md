...
description: >-
  architect procedure: interface contracts. Propose-only when spawned from event commands; touch architecture/ docs via templates.
---
...
Invoked by Forge event commands or the architect agent for `architect/interface-contracts`.
