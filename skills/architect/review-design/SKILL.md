...
name: review-design
description: >-
  architect procedure: review design. Propose-only when spawned from event commands; touch architecture/ docs via templates.
---
...
Invoked by Forge event commands or the architect agent for `architect/review-design`.
