...
name: change-impact
description: >-
  architect procedure: change impact. Propose-only when spawned from event commands; touch architecture/ docs via templates.
---
...
Invoked by Forge event commands or the architect agent for `architect/change-impact`.
