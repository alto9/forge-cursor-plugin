...
4. Propose vendor actions in plan delta before mutating unless parent Apply already accepted them, or the parent event is auto-apply (`/forge.implement-ticket`). This skill is read/poll only — waiting on CI is not a Plan pause.
