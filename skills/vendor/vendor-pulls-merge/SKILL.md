...
4. Propose vendor actions in HITL hand-off before mutating unless parent Apply already approved them, or the parent event is auto-apply (`/forge.validate-ticket`).
