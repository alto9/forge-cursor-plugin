...
name: version-plan
description: >-
  release-manager procedure: version plan. Propose-only when spawned from event commands; touch release/ docs via templates.
---
...
Invoked by Forge event commands or the release-manager agent for `release-manager/version-plan`.
