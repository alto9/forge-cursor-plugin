...
description: >-
  release-manager procedure: publish release. Propose-only when spawned from event commands; touch release/ docs via templates.
---
...
Invoked by Forge event commands or the release-manager agent for `release-manager/publish-release`.
