...
description: >-
  release-manager procedure: write release notes. Propose-only when spawned from event commands; touch release/ docs via templates.
---
...
Invoked by Forge event commands or the release-manager agent for `release-manager/write-release-notes`.
