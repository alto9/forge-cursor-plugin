...
name: status-update
description: >-
  project-manager procedure: status update. Propose-only when spawned from event commands; touch project/ docs via templates.
---
...
Invoked by Forge event commands or the project-manager agent for `project-manager/status-update`.
