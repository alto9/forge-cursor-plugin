...
export const courses = [
    ...
    sessions: [
      {
        ...
        slides: [
          ...
          {
            title: "Next: the nine roles",
            visual: "cycle-steps",
            body: [
              "You have the words, and the rest of this course is who stands at which station: Product Owner, Project Manager, Architect, Designer, Engineer, QA, Security, Release, Marketing, and when they step in.",
        ...
        blocks: [
          ...
          },
          {
            ...
            paragraphs: [
              ...
              "Large themes become initiatives (HLD in memory, then LLD tickets under one host milestone). Outside initiatives, if a cluster would become five or more related tickets, group them under a milestone so the tickets stay finishable and the cluster still has a name, rather than opening a parent ticket you cannot close.",
              "Vague ideas can sit in an icebox as a holding place; sitting there does not promise we will build them. They become tickets only when you are ready to make them specific — or an initiative when the idea is still too large for a single LLD pass.",
            ],
          },
          {
            type: "heading",
  ...
  },
  {
    ...
    sessions: [
      ...
      {
        id: "initiative-hld-lld",
        title: "Initiatives: HLD then LLD",
        duration: "45–55 min",
        source: "commands/forge.new-initiative.md",
        blocks: [
          {
            type: "prose",
            paragraphs: [
              "A large idea is not a ticket and not an epic. It is an initiative: a folder under memory at initiatives/<slug>/ with a lifecycle intake → hld → lld → executing → shipped. You author the high-level design in memory first; the board only appears when HLD sign-offs are green.",
              "On demand, /forge.new-initiative stubs the folder (initiative.md, open-questions.md, features/initiative.feature, optional role docs). It does not create board issues. Then /forge.initiative-design is incremental HLD: Product Owner writes the Gherkin initiative.feature; Architect writes spec.md; Designer writes design.md when the work is user-facing; Security writes security.md (required). Weekly /forge.initiative-planning rolls up open questions, surfaces blockers, and — when every sign-off is green and no blocking OQ is open — proposes status: lld. There is no separate sign-off command.",
              "When status is lld, grooming and refinement are the low-level design passes. /forge.backlog-grooming splits the initiative into actionable tickets on Refinement, always creates one host milestone for that initiative, and stubs features/<ticket-slug>.feature per ticket. /forge.plan-refresh sequences those board_tickets. /forge.refinement compiles each ticket feature into Intention and AC, writes the full Ready body, and for ai-ready slices the HLD spec into the usual <!-- forge-tech-spec --> comment. When the last sibling goes Ready, memory marks the initiative executing. /forge.implement-ticket refuses a partial slice: every sibling on the initiative milestone must already be Ready.",
            ],
          },
          {
            type: "table",
            headers: ["Phase", "Commands", "What moves"],
            rows: [
          ...
          },
          {
            ...
            tone: "note",
            title: "Try it",
            body: "Name one large idea. Sketch the slug, who must sign off, and which command you run when status is still hld versus after it becomes lld. Say out loud why implement waits for every sibling Ready.",
          },
        ],
      },
      {
        id: "po-flow",
        title: "Grooming and refinement (LLD)",
        duration: "50–60 min",
        ...
        blocks: [
          ...
          },
          {
            ...
            tone: "note",
            title: "Try it",
            body: "Groom one LLD outcome from an initiative (or a small standalone wish). If it is user-facing, check that Notes flag design for refinement. Refine it to Ready and ai-ready, including the tech spec comment. Check that Figma refs and states are in the body and the design and structure gates pass. Read the issue and the comment as if the builder cannot ask you follow-up questions.",
          },
        ],
      },
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            rows: [
              ...
              ["new-initiative", "Stub an initiative folder and initiative.feature for a large idea."],
              ["write-initiative-feature", "HLD: author or extend features/initiative.feature."],
              ["initiative-planning", "Weekly HLD cycle: OQ rollup, sign-off gate to status lld."],
              ["open-questions-rollup", "Rebuild product/open-questions.md from initiatives/*/open-questions.md."],
              ["split-initiative", "LLD grooming: split HLD into Refinement tickets + milestone + ticket .feature stubs."],
          ...
          },
          {
            ...
            rows: [
              ...
              ["A large idea needs HLD", "/forge.new-initiative → /forge.initiative-design → /forge.initiative-planning", "new-initiative, write-initiative-feature, initiative-planning"],
          ...
          },
          {
            ...
            lines: [
              ...
              "",
              "0. If this is part of a larger bet: /forge.new-initiative + initiative-design,",
              "   then /forge.initiative-planning until status: lld.",
              "1. /forge.backlog-grooming + split-initiative / groom-ticket",
              ...
              "   One host milestone for the initiative; stub features/<ticket>.feature.",
              "2. Architect may /forge.design-spike if mail is unknown (points at initiatives/<slug>/spec.md).",
              "   You attend with scope-control: spike first, then the feature ticket.",
              "3. /forge.refinement + compile-ticket-feature + agent-ready-ticket",
              "   Outcome, Scope, AC (from .feature), Out of scope, Constraints, Verification, Open questions: None.",
              "   Label: ai-ready (the work stays in the repo).",
              "   Architect + Security post the tech spec comment (from HLD spec.md) before promote.",
              "   Designer inlines Figma refs and states for the reset screens; design and structure gates pass.",
              "4. Only after every sibling on the milestone is Ready: /forge.implement-ticket",
              "5. After ship: /forge.outcomes-retro",
        ...
        blocks: [
          ...
          },
          {
            ...
            rows: [
              ...
              ["/forge.initiative-design", "Product Owner", "HLD: write initiatives/<slug>/spec.md (implementation shape). Sign-off happens later in initiative-planning."],
              ["/forge.refinement", "Product Owner", "For ai-ready: tech spec comment sections (structure, interfaces, constitution gate), sliced from HLD spec when an initiative exists. Call a spike if Ready would be a guess. For human-ready: product-level constraints in the issue body only. UX frames and states belong to Designer, not this seat."],
              ...
              ["/forge.design-system-audit", "Designer", "Optional: structural constraints that affect tokens or shared components, only when the kitchen layout moved."],
            ],
          },
          {
            type: "heading",
          ...
          },
          {
            ...
            headers: ["Skill", "Reach for it when"],
            rows: [
              ["write-initiative-spec", "HLD: initiatives/<slug>/spec.md for the initiative package."],
              ["write-tech-spec", "ai-ready refinement: Architect sections of the tech spec comment (often sliced from HLD spec)."],
              ...
              ["review-design", "A ship call or a proposed layout needs a yes, a no, or a spike. This is system layout, not Figma UX (Designer owns that)."],
            ],
          },
          {
            type: "heading",
          ...
          },
          {
            ...
            rows: [
              ...
              ["The feature ticket would be a guess", "/forge.design-spike", "spike-framing, tradeoff-analysis, tech-selection (structural; UX flows → Designer attends)"],
          ...
          },
          {
            ...
            lines: [
              ...
              "   Refuse: designing the reset screens in the spike (that is Designer’s lane).",
              ...
              "5. Designer attends when the unknown is flows or frames rather than mail.",
              "6. If the vendor stays, lock it with architecture-decision.",
      ...
      },
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            headers: ["Command", "Who leads", "What you bring"],
            rows: [
              ["/forge.refinement", "Product Owner", "Whether the contract is actually buildable, and for ai-ready whether the tech spec is complete. For user-facing work, whether Figma refs and states are in the body. Open questions keep the card in Refinement."],
      ...
      },
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            headers: ["Command", "Who leads", "What you bring"],
            rows: [
              ["/forge.initiative-design", "Product Owner", "HLD: write initiatives/<slug>/security.md (required before status lld)."],
          ...
          },
          {
            ...
            headers: ["Skill", "Reach for it when"],
            rows: [
              ["initiative-security-spec", "HLD: initiatives/<slug>/security.md before planning can flip status to lld."],
        ...
        blocks: [
          ...
          },
          {
            ...
            rows: [
              ...
              ["/forge.initiative-design", "Product Owner", "HLD design.md and Figma screen refs when the initiative is user-facing; N/A sign-off path when it is not."],
              ...
              ["/forge.feedback-triage", "Product Owner", "Usability signal versus product noise; principles only when a durable rule changed."],
            ],
          },
          {
            type: "heading",
          ...
          {
            type: "example",
            title: "Example: design for password reset",
            lines: [
